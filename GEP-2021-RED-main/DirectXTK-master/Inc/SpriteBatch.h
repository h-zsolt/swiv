...
namespace DirectX
{
    ...
    public:
        ...
        // Draw overloads specifying position, m_origin and scale as XMFLOAT2.
        ...
        // Draw overloads specifying position, m_origin and scale via the first two components of an XMVECTOR.
