...
//  [X] Renderer: Support for large meshes (64k+ m_vertices) with 16-bit indices.
...
//  2019-05-29: DirectX11: Added support for large mesh (64K+ m_vertices), enable ImGuiBackendFlags_RendererHasVtxOffset flag.
...
bool    ImGui_ImplDX11_CreateDeviceObjects()
{
    ...
    // Create the vertex shader
    {
        static const char* vertexShader =
            ...
            {\
              PS_INPUT output;\
              output.m_position = mul( ProjectionMatrix, float4(input.m_position.xy, 0.f, 1.f));\
